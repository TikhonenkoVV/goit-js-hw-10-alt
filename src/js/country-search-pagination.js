// import { lodashDebounce } from './country-search.js';
...
//         refs.countriesList.innerHTML = curData.map(createCountryCards).join('');
...
//   'input',
//   lodashDebounce(onSearchInput, DEBOUNCE_DELAY)
// );
